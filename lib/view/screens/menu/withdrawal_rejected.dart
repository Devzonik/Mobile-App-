...
class RejectedWithdrawals extends StatefulWidget {
  const RejectedWithdrawals({Key? key});

  @override
  State<RejectedWithdrawals> createState() => _RejectedWithdrawalssState();
}

class _RejectedWithdrawalssState extends State<RejectedWithdrawals> {
