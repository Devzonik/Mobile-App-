...
class RejectedRecharges extends StatefulWidget {
  const RejectedRecharges({Key? key});

  @override
  State<RejectedRecharges> createState() => _RejectedRechargestate();
}

class _RejectedRechargestate extends State<RejectedRecharges> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: depositCollection
          ...
          .where('approved', isEqualTo: 'rejected')
          .snapshots(),
                    ...
                    children: [
                      Positioned(
                        ...
                        child: CommonImageView(
                          imagePath: Assets.imagesRejected,
                          height: 50,
                        ),
                      ),
                      Column(
