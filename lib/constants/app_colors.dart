...
const kSecondaryColor = Color(0xff0573A9);
const kSecondaryColor2 = Color.fromARGB(255, 255, 136, 0);
...
const LinearGradient bluess = LinearGradient(
    colors: [
      Color.fromARGB(255, 5, 202, 228),
      Color.fromARGB(255, 3, 109, 151),
      Color.fromARGB(255, 3, 69, 73),
      // End color
    ],
    stops: [
      0.2,
...
const LinearGradient bluess2 = LinearGradient(
    colors: [
      Color.fromARGB(255, 5, 202, 228),
      Color.fromARGB(255, 3, 109, 151),
      Color.fromARGB(255, 3, 69, 73),
...
const LinearGradient purple = LinearGradient(
  begin: Alignment.topCenter,
  end: Alignment.bottomCenter,
